...
# methods for encrypting / decrypting draws
...
class Draw(db.Model):
    ...
    # Encryption and decryption of draws
...
# Creation of the admin class to be added to DB
def init_db():
    db.drop_all()
    db.create_all()
    new_user = User(email='admin@email.com',
                 password='Admin1!',
